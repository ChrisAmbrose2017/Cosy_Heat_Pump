...
As of 2026, Octopus Energy migrated heat pump queries to a new backend endpoint. This script uses a **two-endpoint authentication pattern**:
...
| `octoHeatPumpLivePerformance` | `heatPumpLivePerformance` |
